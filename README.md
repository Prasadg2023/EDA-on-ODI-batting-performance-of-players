[README.md](https://github.com/user-attachments/files/26201024/README.md)
...
- Strike_rate_distribution

- Bubbleplot – Matches, Runs, Batting Average

---
<!--
# ▶️ How to Run this Project  
1. git clone https://github.com/Prasadg2023/EDA-on-ODI-batting-performance-of-players.git
cd EDA-on-ODI-batting-performance-of-players

2. pip install -r requirements.txt

3. jupyter notebook Cricket_EDA.ipynb
-->
---
...
- Incorporate real-time data integration (live match stats, player fitness, weather conditions).
- Perform team combination optimization using advanced analytics techniques.
- Use data storytelling and visualization techniques to present insights more effectively.
- Expand analysis across different leagues and international matches for broader comparison.
- Implement player ranking and recommendation systems based on performance metrics.
